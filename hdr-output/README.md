...
Select **LSUnDIsplayACongif** in **World Outliner** and drag the **SRGBtoPQ** item to **OCIO | Configuration Source**.  Then select the **Source Color** as **Utility - Linear - sRGB** and **Destination Color** as **Output - LED Walls - PQ**.
